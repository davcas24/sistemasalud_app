...
jQuery(function($){
	...
	frmvalidator.addValidation("Correo","req","Por favor ingrese su correo");
	frmvalidator.addValidation("Correo","email","Correo Invalido");*/
    ...
    wow.init();
		...
		function initMap() {
			...
			var map = new google.maps.Map(mapDiv, {
				center: {lat: 14.094667, lng: -87.190755},
				zoom: 8
			});
		}
